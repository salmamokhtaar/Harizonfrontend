...
function Users() {
    ...
    useEffect(() => {
        ...
        axios.get('https://harizonbackend.onrender.com/api/users')
            .then(response => {
    ...
    const handleUpdateUser = (updatedUser) => {
        axios.put(`https://harizonbackend.onrender.com/api/users/${updatedUser._id}`, updatedUser)
            .then(response => {
    ...
    const handleDeleteUser = (userId) => {
        ...
        if (confirmed) {
            axios.delete(`https://harizonbackend.onrender.com/api/users/${userId}`)
                .then(response => {
