...
function UpdateCustomer({ customer, onUpdate }) {
    ...
    const handleStatusChange = (e) => {
        ...
        axios.put(`https://harizonbackend.onrender.com/api/contacts/${formData._id}/status`, { status: value })
            .then(response => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.put(`https://harizonbackend.onrender.com/api/contacts/${formData._id}`, formData)
            .then(response => {
