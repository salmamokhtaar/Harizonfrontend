...
function ViewCustomers() {
    ...
    useEffect(() => {
        ...
        axios.get('https://harizonbackend.onrender.com/api/contacts/')
            .then(response => {
    ...
    const handleUpdateCustomer = (updatedCustomer) => {
        axios.put(`https://harizonbackend.onrender.com/api/contacts/${updatedCustomer._id}`, updatedCustomer)
            .then(response => {
    ...
    const handleDeleteCustomer = (customerId) => {
        ...
        if (confirmed) {
            axios.delete(`https://harizonbackend.onrender.com/api/contacts/${customerId}`)
                .then(response => {
    ...
    const handleStatusChange = (customerId, status) => {
        axios.put(`https://harizonbackend.onrender.com/api/contacts/${customerId}/status`, { status })
            .then(response => {
                const updatedCustomers = customers.map(customer =>
